...
class QuizHardLeaderboard extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  componentDidMount() {
    const request = new Request('http://127.0.0.1:8080/quizhardleaderboard/'+this.props.id);
    fetch(request)
...
export default QuizHardLeaderboard;
